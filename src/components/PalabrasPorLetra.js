const palabrasPorLetra = {
  a: [
    { img: "/images/a/Auto.png", sound: "/sound/Auto.mp3", nombre: "Auto" },
  ...
  o: [
    ...
    { img: "/images/o/oso.png", sound: "/sound/oso.mp3", nombre: "Oso" },
    { img: "/images/o/Oveja.png", sound: "/sound/oveja.mp3", nombre: "Oveja" },
    { img: "/images/o/ojo.jpg", sound: "/sound/ojo.mp3", nombre: "Ojo" },
    { img: "/images/o/oruga.jpg", sound: "/sound/oruga.mp3", nombre: "Oruga" }
  ],
  u: [
    ...
    { img: "/images/u/ukelele.jpg", sound: "/sound/ukelele.mp3", nombre: "Ukelele" },
    { img: "/images/u/urraca.jpg", sound: "/sound/urraca.mp3", nombre: "Urraca" },
  ],
};

export default palabrasPorLetra;
